...
public class SpanishAiActionAliases implements AiActionAliasProvider {
    ...
    public void addAliases(Map<String, String> map, Status status, boolean isDryRun) {
        ...
        if (status.isInMainShip() || isDryRun) {
            ...
            // combat
            map.put("desplegar hardpoints, armas activas, listo para combate, armas libres, sacar armas, armar armas, armas listas", DEPLOY_HARDPOINTS.getAction());
            map.put("retraer hardpoints, armas frías, guardar armas, alto al combate, enfundar armas, bajar armas, asegurar armas", RETRACT_HARDPOINTS.getAction());
        ...
        map.put("a dónde va el carrier del escuadrón, rumbo del carrier del escuadrón, destino final del carrier del escuadrón", SQUADRON_CARRIER_ROUTE.getAction());
        ...
        map.put("desactivar todos los anuncios", DISABLE_ALL_ANNOUNCEMENTS.getAction());
